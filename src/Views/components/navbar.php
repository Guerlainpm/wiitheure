        ...
        if (isset($_SESSION["user"])) {
          ?>
            <div class="w-64 h-20 justify-between flex flex-col items-center">
              <h2 class="flex flex-wrap items-center text-white">Connecter en tant que: <a href="/profile/<?php echo $_SESSION['user']->getId(); ?>" class="ml-2 underline uppercase"><?php echo $_SESSION["user"]->getUsername(); ?></a></h2>
